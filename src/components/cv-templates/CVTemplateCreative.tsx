    ...
    <div className="bg-[#f8f9fa] text-slate-900 p-4 md:p-10 w-full md:w-[210mm] min-h-screen md:min-h-[297mm] mx-auto font-sans flex flex-col gap-4 md:gap-6 print:w-[210mm] print:h-[297mm] print:p-6" id="cv-creative">
      <style>{`
        @media print {
          ...
          header { padding: 10pt !important; border-radius: 10pt !important; background-color: #0f172a !important; color: white !important; margin-bottom: 4pt !important; display: flex !important; flex-direction: row !important; justify-content: space-between !important; align-items: center !important; }
          section { padding: 8pt !important; border-radius: 10pt !important; margin-bottom: 0 !important; background: white !important; }
          ...
          .rounded-\\[40px\\] { border-radius: 10pt !important; }
          .grid { display: grid !important; gap: 6pt !important; }
          .md\\:grid-cols-2 { grid-template-columns: repeat(2, 1fr) !important; }
          .lg\\:grid-cols-3 { grid-template-columns: repeat(3, 1fr) !important; }
          .line-clamp-3 { -webkit-line-clamp: unset !important; display: block !important; }
        }
      `}</style>
      {/* Header Bento Box */}
